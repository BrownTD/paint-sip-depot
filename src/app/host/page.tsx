...
export default async function HostPage() {
  ...
  return (
    <div className="min-h-screen">
      ...
      <section id="how-it-works" className="scroll-mt-24 bg-muted/20 px-4 py-8 md:py-32">
        <div className="mx-auto w-full max-w-[1400px]">
          <div className="mt-4 flex flex-col md:grid md:grid-cols-3 md:gap-8 lg:gap-12">
            {[
              {
                number: "1",
              ...
              >
                <div className="flex flex-col items-center px-1 py-6 text-center md:px-0 md:py-0">
                  ...
                  {step.imageSrc ? (
                    <div className="relative mt-8 min-h-[280px] w-full max-w-xl md:min-h-[340px] md:max-w-none lg:min-h-[400px]">
                      <Image
                        src={step.imageSrc}
                        alt={step.title}
                        fill
                        sizes="(max-width: 768px) 100vw, 33vw"
                        className="scale-105 object-contain md:scale-100"
                      />
                    </div>
                  ) : (
                ...
                {index < steps.length - 1 ? (
                  <div
                    className="mt-8 mx-auto h-px w-full max-w-sm bg-foreground/14 md:hidden"
                    aria-hidden="true"
                  />
                ) : null}
              </div>
      ...
      <section className="px-2 py-[50px] sm:px-4 md:-mt-[60px]">
        <div className="mx-auto w-full max-w-[1400px]">
          <div className="relative overflow-hidden rounded-3xl bg-primary px-6 pb-[60px] pt-6 text-center sm:px-8 sm:pb-[72px] sm:pt-8 md:p-16">
